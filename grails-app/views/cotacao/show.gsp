...
<html>
    ...
    <body>
        ...
        <div id="show-cotacao" class="content scaffold-show" role="main">
            ...
            <f:display bean="cotacao" />
            <g:form resource="${this.cotacao}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.cotacao}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
